...
@Composable
fun DashboardScreen(state: UiState, onRescan: () -> Unit = {}) {
    ...
    Column(
        ...
        androidx.compose.material3.OutlinedButton(
            ...
            Text(if (state.rescanning) "Re-scanning inbox…" else "Re-scan inbox")
        }
        Text(
            "Wipes parsed data and re-reads every bank SMS with the latest rules. Use this if amounts look wrong.",
